...
duplicates, references to entities that don't exist (or don't exist *yet*),
malformed and out-of-range values.

In my own words: the hard part is not moving CSVs into tables. It is deciding
**what a failed check means** — some failures are permanent facts about a row,
